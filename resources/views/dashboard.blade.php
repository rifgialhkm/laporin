...
@section('content')
    <section class="section">
        <div class="section-header d-flex flex-column justify-content-center bg-transparent shadow-none">
            <h1>Layanan Pengaduan Online Masyarakat</h1>
            <p>Sampaikan laporan atau keluhan Anda melalui layanan Lapor!n</p>
        </div>
            ...
            <div class="col-12 col-md-8 p-0 mx-auto mb-5">
                <div class="card">
                    <div class="card-header bg-primary">
                        <p class="text-white font-weight-bold m-0" style="font-size:1.3rem;">Sampaikan Laporan atau Keluhan Anda</p>
                    </div>
                    <div class="card-body">
